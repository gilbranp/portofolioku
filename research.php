    ...
    <body>
       ...
       <div id="myNav" class="navbar" style="background-color: rgba(0,0,0,0.9);">
          ...
          <div class="navbar-content">
            ...
            <a href="research.php" id="active">Research</a>
            ...
            <div class="content">
                <div class="part-left">
                    <div class="impart-re">
                        ...
                        <div class="website-name">
                            <h2>Radenta Gilbran Salsyarizki Home Page</h2>
                        </div>
                    </div>
                    <div class="tepart-re">
                ...
                <div class="part-right">
                    <div class="impart-re">
                        ...
                        <div class="overlay">
                            <a href="home.php" class="icon" title="Go to site" target="_blank"><img src="images/Iconslogo/link-50.png" class="link"></a>
                        </div>
                        <div class="website-name">
                            <h2>My Home Page</h2>
                        </div>
            ...
            <div class="content">
                ...
                <div class="part-right">
                    <div class="impart-re">
                        ...
                        <div class="overlay">
                            <a href="home.php#contact" class="icon" title="Go to site" target="_blank"><img src="images/Iconslogo/link-50.png" class="link"></a>
                        </div>
                        <div class="website-name">
            ...
            <div class="content">
                ...
                <div class="part-right">
                    <div class="impart-re">
                        ...
                        <div class="overlay">
                            <a href="resume.php#skill-section" class="icon" title="Go to site" target="_blank"><img src="images/Iconslogo/link-50.png" class="link"></a>
                        </div>
                        <div class="website-name">
            ...
            <div class="content">
                ...
                <div class="part-right">
                    <div class="impart-re">
                        ...
                        <div class="overlay">
                            <a href="blog.php" class="icon" title="Go to site" target="_blank"><img src="images/Iconslogo/link-50.png" class="link"></a>
                        </div>
                        <div class="website-name">
                            <h2>My Blog Page</h2>
                        </div>
            ...
            <div class="content">
                ...
                <div class="part-right">
                    <div class="impart-re">
                        ...
                        <div class="overlay">
                            <a href="home.php#testimonial" class="icon" title="Go to site" target="_blank"><img src="images/Iconslogo/link-50.png" class="link"></a>
                        </div>
                        <div class="website-name">
